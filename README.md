...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/cnxiekun/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/cnxiekun/dotfiles/master/install.sh`" -s ask
```
